...
import com.a403.ffu.reservation.dto.AvailableDateTime;
import com.a403.ffu.reservation.dto.ReportDetailResponse;
import com.a403.ffu.reservation.dto.ReportResponse;
import com.a403.ffu.reservation.dto.ReportsListResponse;
import com.a403.ffu.reservation.dto.ReservationRequest;
import com.a403.ffu.reservation.dto.ReservationResponse;
import com.a403.ffu.reservation.dto.ReviewRequest;
import com.a403.ffu.reservation.dto.ReviewResponse;
import com.a403.ffu.reservation.dto.UpdateResultRequest;
...
public class CounselingReservationController {
    ...
    public List<AvailableDateTime> availableDate(@PathVariable Long counselorNo,
    ...
    public ResponseEntity<String> reserve(@AuthenticationPrincipal LoginUser loginUser,
        ...
        try {
            ...
            Long counselorId = reservationRequest.counselorId();
            String reservationType = reservationRequest.reservationType();
            LocalDateTime reservationDate = reservationRequest.reservationDate();

            String reservation = counselingReservationService.saveReservation(memberId, counselorId,
    ...
    public List<ReservationResponse> getCounselorRezInfo(
            @AuthenticationPrincipal LoginUser loginUser, @PathVariable String date) {
        Long counselorId = loginUser.getMember().getCounselor().getNo();
    ...
    public String saveReview(@RequestBody ReviewRequest reviewRequest,
        ...
        Long memberId = loginUser.getMember().getNo();
        String review = reviewRequest.reservationReview();
        Float rez_score = reviewRequest.reservationScore();
