...
import com.a403.ffu.global.security.oauth.mapper.AttributeMapperFactory;
...
import com.a403.ffu.member.service.AuthService;
...
/**
 * i. access token을 이용해 서드파티 서버로부터 사용자 정보를 받아옴 ii. 사용자 정보를 파탕으로 회원가입된 사용자인지 확인 iii. LoginUser(User
 * Principal) 반환
 */
@Service
...
public class DefaultUserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        return loginUserMapper.toLoginUser(
                authService.saveIfNotExists(oAuth2Request)); // OAuth2User 객체 리턴
    }
}
